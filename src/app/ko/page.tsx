...
const faq = [
  ...
  { question: "영업시간은 언제인가요?", answer: "매일 07:00–22:00에 운영합니다. 공휴일이나 특별 운영일에는 방문 전에 매장에 최신 시간을 확인하세요." },
];
    ...
    <main id="main-content" className={styles.page} lang="ko-KR">
      ...
      <section className={styles.intro} aria-labelledby="ko-intro-title">
        ...
        <div className={styles.introCopy}>
          ...
          <div className={styles.answerBox}>Tarihi Van Kahvaltı Evi는 베요글루 잠박 거리에서 1978년부터 이어온 가족의 반 아침 문화를 선보입니다. 매일 07:00–22:00 운영하며 탁심 광장과 이스티클랄 거리에서 걸어서 방문할 수 있습니다.</div>
        </div>
      </section>
